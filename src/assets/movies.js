...
export default [
    ...
    { id: 15, title: '', eventYear: 1950.09, event: '장사상륙작전', summary: '', imageUrl: 장사리 },
    { id: 16, title: '', eventYear: 1950.09, event: '인천상륙작전', summary: '기적? 그건 작전이었다', imageUrl: 인천상륙작전 },
    { id: 17, title: '', eventYear: 1950.11, event: '중공군 개입', summary: '', imageUrl: 웰컴투동막골 },
    ...
    { id: 24, title: '', eventYear: 1971, event: '베트남 전쟁', summary: '', imageUrl: 님은먼곳에 },
    { id: 25, title: '', eventYear: 1972, event: '베트남 전쟁', summary: '', imageUrl: 알포인트 },
    ...
    { id: 28, title: '', eventYear: 1979, event: '12·12사태', summary: '', imageUrl: 행복의나라 },
    ...
    { id: 32, title: '', eventYear: 1980, event: '5·18민주화운동', summary: '', imageUrl: 박하사탕 },
    ...
    { id: 37, title: '', eventYear: 1986, event: '화성연쇄살인사건', summary: '', imageUrl: 살인의추억 },
    ...
    { id: 41, title: '', eventYear: 1991, event: '낙동강 페놀 유출사건', summary: '', imageUrl: 삼진그룹 },
