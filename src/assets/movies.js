...
export default [
    ...
    { id: 28, title: '서울의 봄', event: '12·12사태', summary: '누구도 예상 못한 생일잔치', imageUrl: 서울의봄 },
    { id: 29, title: '행복의 나라', event: '12·12사태', summary: '5공 유니버스의 마무리', imageUrl: 행복의나라 },
    ...
    { id: 32, title: '박하사탕', event: '5·18민주화운동', summary: '한 남자의 되돌릴 수 없는 과거', imageUrl: 박하사탕 },
    ...
    { id: 35, title: '남영동', eventYear: 1985, event: '서울대 민추위 사건', summary: '삭제된 509호 고문실의 기록', imageUrl: 남영동 },
    { id: 36, title: '비공식작전', eventYear: 1986, event: '레바논 한국 외교관 \n납치 사건', summary: '상부에선 ‘공식적으로 \n이 작전이 없었다’고 한다', imageUrl: 비공식작전 },
    { id: 37, title: '살인의 추억', event: '화성연쇄살인사건', summary: '밥 잘 먹고 다닙시다', imageUrl: 살인의추억 },
    ...
    { id: 46, title: '추격자', eventYear: 2003, event: '유영철 연쇄살인 사건', summary: '혹시 망치나 몽둥이 같은 거 있어요?', imageUrl: 추격자 },
